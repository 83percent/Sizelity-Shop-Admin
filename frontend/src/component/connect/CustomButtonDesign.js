...
const CustomButtonDesign = () => {
    ...
    return (
        <article id="custom-design">
            ...
            <h3>HTML 코드</h3>
            <textarea readOnly value={`<button onclick="location.href='https://www.sizelity.com/compare?domain='+encodeURIComponent(location.href)" style="all:unset; position: fixed; z-index: 999; box-shadow: 0px 8px 10px 0px #55555510;bottom: ${bottom || 12}px; right: ${right || 12}px;"><div style="cursor:pointer;width: 3.7rem; height: 3.7rem; display: flex; align-items: center; justify-content: center; border-radius: 50%; background-color: ${backColor || "#00966B"};"><svg xmlns="http://www.w3.org/2000/svg" height="2rem" viewBox="0 0 24 24" width="2rem" fill="${baseColor || "#ffffff"}"><path d="M0 0h24v24H0z" fill="none"/><path d="M21.41 11.58l-9-9C12.05 2.22 11.55 2 11 2H4c-1.1 0-2 .9-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58.55 0 1.05-.22 1.41-.59l7-7c.37-.36.59-.86.59-1.41 0-.55-.23-1.06-.59-1.42zM5.5 7C4.67 7 4 6.33 4 5.5S4.67 4 5.5 4 7 4.67 7 5.5 6.33 7 5.5 7z"/></svg></div></button>`}>
